...
var FullCalendar = (function (exports) {
    ...
    var CalendarApi = /** @class */ (function () {
        ...
        CalendarApi.prototype.getEventById = function (id) {
            ...
            for (var defId in defs) {
                var def = defs[defId];
                if (def.publicId === id) {
                    log.debug("최적화 주석2 : {}", def.publicId);
                    if (def.recurringDef) {
                    ...
                    for (var instanceId in instances) {
                        ...
                        if (instance.defId === def.defId) {
                            log.debug("최적화 주석3 : {}", new EventApi(state, def, instance));
    ...
    var EventApi = /** @class */ (function () {
        ...
        */
        ...
        EventApi.prototype.setExtendedProp = function (name, val) {
            ...
            log.debug("set 확장 (setExtendedProp) : {}", EventApi.prototype.setExtendedProp);
        };
        //setStart 셋팅시작?
        EventApi.prototype.setStart = function (startInput, options) {
            ...
            log.debug("setStart1 : {}", EventApi.prototype.setStart);
        };
        ...
        EventApi.prototype.setEnd = function (endInput, options) {
            ...
            log.debug("셋팅종료? : {}", EventApi.prototype.setEnd);
        };
        //setDates 날짜 저장?
        EventApi.prototype.setDates = function (startInput, endInput, options) {
            ...
            if (endInput != null) {
                ...
                log.debug("날짜저장2(종료날짜가 null아니면) : {}", start);
            ...
            if (this._instance) {
                ...
                if (options.allDay === true) {
                    ...
                    log.debug("모든 날짜데이터1 : {}", options.allDay);
                }
                //델타출발
                var startDelta = diffDates(instanceRange.start, start, dateEnv, options.granularity);
                log.debug("델타출발1 : {}", startDelta);
                if (end) {
    ...
    */
    ...
    function handleEventSources(inputs, context) {
        ...
        log.debug('eventSources', unfoundSources.values);
        var newInputs = [];
